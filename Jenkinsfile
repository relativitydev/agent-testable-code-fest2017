...
node('master') {
        ...
        stage('Stage build'){
			    ...
			    utilites.build_solution("C:/Program Files (x86)/Microsoft Visual Studio/2017/Professional/MSBuild/15.0/Bin/MSBuild.exe\", "RelativityAgent1RelativityAgent.sln)
