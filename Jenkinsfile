...
node('master') {
        ...
        stage('Stage build'){
                fileExists location
                bat 'S:/nuget.exe restore Relativity Agent1\\RelativityAgent.sln'
                bat 'S:/nuget.exe restore Relativity Agent1\\Relativity Agent1\\packages.config -PackagesDirectory Relativity Agent1\\packages'
